...
import avinash.app.audiocallapp.AudioCallApp
...
class CallForegroundService : Service() {
    ...
    private fun updateNotificationWithNetworkStatus(status: String? = null) {
        if (isCallActive) {
            ...
            val notification = createCallNotification(remoteUserName, false).let { base ->
                NotificationCompat.Builder(this, AudioCallApp.CALL_CHANNEL_ID)
    ...
    private fun createCallNotification(userName: String, isIncoming: Boolean): Notification {
        ...
        return NotificationCompat.Builder(this, AudioCallApp.CALL_CHANNEL_ID)
            .setContentTitle(title)
            .setContentText(text)
            .setSmallIcon(R.drawable.ic_launcher_foreground)
            .setOngoing(true)
    ...
    fun updateCallStatus(status: String) {
        if (isCallActive) {
            val notification = NotificationCompat.Builder(this, AudioCallApp.CALL_CHANNEL_ID)
